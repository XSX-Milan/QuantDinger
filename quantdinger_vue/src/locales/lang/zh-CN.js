...
const locale = {
  ...
  'dashboard.indicator.backtest.importConfig': '导入配置',
  'dashboard.indicator.backtest.exportConfig': '导出配置',
  'dashboard.indicator.backtest.importSuccess': '配置加载成功',
  'dashboard.indicator.backtest.importFailed': '导入配置失败',
  'dashboard.indicator.backtest.exportFailed': '导出配置失败',
  ...
  'dashboard.indicator.backtest.tabManual': '手动回测',
  'dashboard.indicator.backtest.tabAI': 'AI 优化',
  'dashboard.indicator.backtest.targetMetric': '优化目标',
  'dashboard.indicator.backtest.maxIterations': '最大迭代次数',
  'dashboard.indicator.backtest.model': 'AI模型',
  'dashboard.indicator.backtest.startOpt': '开始优化',
  'dashboard.indicator.backtest.stop': '停止',
  'dashboard.indicator.backtest.applyBest': '应用最佳参数',
  'dashboard.indicator.backtest.exportBest': '导出最佳配置',
  'dashboard.indicator.backtest.appliedParams': '最佳参数已应用到手动回测表单',
  'dashboard.indicator.backtest.saveParamsTitle': '更新源代码？',
  'dashboard.indicator.backtest.saveParamsDesc': '是否将优化后的参数更新到指标源代码中？这将重写代码中的默认参数值。',
